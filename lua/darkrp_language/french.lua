...
local my_language = {
    ...
    need_sadmin = "Vous avez besoin de super privilèges d’administrateur pour pouvoir %s",
    no_privilege = "Vous n’avez pas les droits pour effectuer cette action",
    no_jail_pos = "Pas de prison configugé",
    ...
    you_donated = "Vous avez donné %s to %s!",
    ...
    property_tax = "Impôt foncier! %s",
    property_tax_cant_afford = "Vous ne pouviez pas payer les impôts! Votre propriété vous a été enlevée!",
    taxday = "Jour de l’impôt! %s%% de vos revenus a été pris!",

    found_cheque = "Vous avez trouvé %s%s par chèque libellé à l’ordre de %s.",
    cheque_details = "Ce chèque est libellé à l’ordre de %s.",
    cheque_torn = "Vous avez déchiré le chèque.",
    cheque_pay = "Paie: %s",
    signed = "Signé: %s",

    found_cash = "Vous avez décroché %s%d!", -- backwards compatibility
    found_money = "Vous avez décroché %s!",
    ...
    youre_arrested = "Vous avez été arrêté. Il reste : %d secondes !",
    ...
    warrant_ordered = "%s ordered a search warrant for %s. Raison: %s",
    ...
    wanted_by_police_print = "%s a fait rechercher %s, raison: %s",
    wanted_expired = "%s n’est plus recherché par la police.",
    wanted_revoked = "%s n’est plus recherché par la police.\nrévoqué par: %s",
    cant_arrest_other_cp = "Vous ne pouvez pas arrêter d’autres personnes !",
    ...
    cant_arrest_no_jail_pos = "Vous ne pouvez pas arrêter les gens puisqu’il n’y a pas de place en prison !",
    ...
    remove_a_warrant = "Lever un mandat",
    make_someone_wanted = "Rechercher quelqu'un",
    remove_wanted_status = "Retirer un avis de recherche",
    already_a_warrant = "Il y a déjà un mandat pour ce suspect.",
    ...
    need_to_be_cp = "Il faut être policier.",
    ...
    kills = "Meurtres: %s",
    deaths = "Morts: %s",
    rpname_changed = "%s a changé son RPName pour: %s",
    disconnected_player = "Déconnecter le joueur",
    player = "Joueur",
